...
def getWeather():
    ...
    api = "https://api.openweathermap.org/data/2.5/onecall?lat="+str(location.latitude)+"&lon="+str(
        location.longitude)+"&units=metric&exclude=hourly&appid=91b91fa6d849260f2ea77580e4d8e93d"
...
# icon
image_icon = PhotoImage(file="C:\weather\images\logos.png")
root.iconphoto(False, image_icon)


Round_box = PhotoImage(file="C:\weather\images\Rounded rectangle 1.png")

Label(root, image=Round_box, bg="#808081").place(x=30, y=110)
...
# Search box
Search_image = PhotoImage(file="C:\weather\images\Rounded Rectangle 3.png")
myimage = Label(image=Search_image, bg="#808081")
myimage.place(x=270, y=120)

weat_image = PhotoImage(file="C:\weather\images\Layer 7.png")
...
Search_icon = PhotoImage(file="C:\weather\images\Layer 6.png")
...
# bottom boxes
firstbox = PhotoImage(file="C:\weather\images\Rounded Rectangle 2.png")
secondbox = PhotoImage(file="C:\weather\images\Rounded Rectangle 2 copy.png")
...
# clock
clock = Label(root, font=("Helvetica", 30, 'bold'), fg="white", bg="#808081")
clock.place(x=30, y=20)


# timezone
timezone = Label(root, font=("Helvetica", 20), fg="white", bg="#808081")
timezone.place(x=700, y=20)

long_lat = Label(root, font=("Helvetica", 0), fg="white", bg="#808081")
...
day1temp = Label(firstframe, bg="#282829", fg="#99ffff", font="arial 15 bold")
